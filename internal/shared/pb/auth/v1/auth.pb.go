...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\vcom.auth.v1B\tAuthProtoP\x01Z<github.com/ekkx/tcmrsv-web/internal/shared/pb/auth/v1;authv1\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	0, // 1: auth.v1.ReauthorizeResponse.auth:type_name -> auth.v1.Auth
	1, // 2: auth.v1.AuthService.Authorize:input_type -> auth.v1.AuthorizeRequest
	3, // 3: auth.v1.AuthService.Reauthorize:input_type -> auth.v1.ReauthorizeRequest
	5, // 4: auth.v1.AuthService.UpdatePassword:input_type -> auth.v1.UpdatePasswordRequest
	2, // 5: auth.v1.AuthService.Authorize:output_type -> auth.v1.AuthorizeResponse
	4, // 6: auth.v1.AuthService.Reauthorize:output_type -> auth.v1.ReauthorizeResponse
	6, // 7: auth.v1.AuthService.UpdatePassword:output_type -> auth.v1.UpdatePasswordResponse
