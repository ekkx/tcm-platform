...
const file_room_v1_room_proto_rawDesc = "" +
	...
	"\vRoomService\x12]\n" +
	"\x12ListAvailableRooms\x12\".room.v1.ListAvailableRoomsRequest\x1a#.room.v1.ListAvailableRoomsResponseB\x9a\x01\n" +
	"\vcom.room.v1B\tRoomProtoP\x01ZCgithub.com/ekkx/tcmrsv-web/server/internal/shared/pb/room/v1;roomv1\xa2\x02\x03RXX\xaa\x02\aRoom.V1\xca\x02\aRoom\\V1\xe2\x02\x13Room\\V1\\GPBMetadata\xea\x02\bRoom::V1b\x06proto3"
