...
const file_v1_authorization_authorization_proto_rawDesc = "" +
	...
	"\vReauthorize\x12$.authorization.v1.ReauthorizeRequest\x1a\".authorization.v1.ReauthorizeReplyB<Z:github.com/ekkx/tcmrsv-web/server/pkg/api/v1/authorizationb\x06proto3"
